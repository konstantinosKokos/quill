...
class Model(Module):
    def __init__(self, num_layers: int, dim: int, max_scope_size: int, max_db_index: int):
        ...
        self.type_encoder = TypeEncoder(
            ...
            dim=dim)
        self.lemma_predictor = Sequential(Dropout(0.15), Linear(dim, 1))
